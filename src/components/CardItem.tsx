    ...
    return (
        <Card className="flex-shrink-0 mx-2 basis-1/2 sm:basis-2/5 md:basis-1/5">
            <div className='flex flex-col items-start justify-start overflow-hidden'>
                ...
                <Link to={`/${!movie?'series':'movie'}/${imdbID}`}><img src={poster} alt='poster' className="object-cover overflow-hidden transition duration-500 transform hover:scale-150" loading="lazy" /></Link>
